...
<div class="container mt-3">
  <h2 title="dibuat oleh eri yulian hidayat jangan dicopy">ENTRI MATA KULIAH</h2>
  <form action="fc.php" method="POST">
    ...
    <button type="submit" name="dayat" class="btn btn-primary" title="dibuat oleh eri yulian hidayat jangan dicopy">Simpan record</button> <a href="dft.php" class="btn btn-dark" title="dibuat oleh eri yulian hidayat jangan dicopy"> Daftar mata kuliah</a>
  </form>
</div>
</body>
</html>
<!-- dikerjakan tanggal 27-11-2022 jam 1:47 wib 